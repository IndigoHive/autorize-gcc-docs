...
<Steps>
  ...
  <Step title="Usuário recebe webhook com hash de consulta">
    <Card>
      ...
      ```
      Verifique a seção de Webhooks para mais detalhes sobre como configurar e receber notificações de eventos, incluindo o hash de consulta gerado após a concessão do consentimento pelo titular.
      ...
      <Card
        ...
        href="/guias/webhooks"
        arrow="true"
        cta="Acessar a documentação dos Webhooks"
      >
        Clique aqui para acessar a documentação dos Webhooks.
      </Card>
    </Card>
  </Step>
  <Step title="Usuário utiliza hash para realizar consultas">
    <Card>
      ...
      https://hom-pgcc.np.bsa.estaleiro.serpro.gov.br/manual/servicos_usuarios/swagger_pgcc_consultas_api/
    </Card>
  </Step>
</Steps>
